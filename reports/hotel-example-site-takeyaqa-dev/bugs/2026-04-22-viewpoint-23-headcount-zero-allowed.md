...
- `tests/generated/viewpoint-23-prohibited.spec.ts` - 「人数に0を指定できないこと」
...
- Date: `2026-04-22`
- Viewpoint: `23 禁則`
- Severity: `High` (業務ルール違反。0人の予約は意味がない)
- Finding ID: `F-20260422-05`
- Hypothesis: `H-20260422-02` (numberフィールドのmin属性未設定)
- Related bugs / findings: F-20260422-04 (宿泊数0も同様)
